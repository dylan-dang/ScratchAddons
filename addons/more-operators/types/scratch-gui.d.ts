...
declare namespace ScratchGUI {
  ...
  type DragPayload = ScratchVM.Costume | ScratchVM.Sound;
  ...
  interface ScratchGUIState {
    ...
    targets: {
      sprites: Record<
        string,
        ScratchVM.RenderedTarget & {
          order: number;
        }
      >;
      stage: ScratchVM.RenderedTarget | {};
  ...
  type ScratchGUIEvent =
    ...
    | {
        ...
        targets: ScratchVM.RenderedTarget[];
        editingTarget: string | null;
      }
    | {
