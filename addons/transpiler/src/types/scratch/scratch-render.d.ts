...
declare namespace RenderWebGL {
  ...
  class ShaderManager {
    ...
    _gl: AnyWebGLContext;
    _shaderCache: Record<DrawMode, Record<EffectMask, import("twgl.js").ProgramInfo[]>>;
    _buildShader(drawMode: DrawMode, effectMask: EffectMask): import("twgl.js").ProgramInfo;
    getShader(drawMode: DrawMode, effectMask: EffectMask): import("twgl.js").ProgramInfo;
  }
  ...
  class Silhouette {
    ...
    colorAtNearest(textureCoordinate: import("twgl.js").v3.Vec3, destination?: Uint8ClampedArray): Uint8ClampedArray;
    colorAtLinear(textureCoordinate: import("twgl.js").v3.Vec3, destination?: Uint8ClampedArray): Uint8ClampedArray;

    isTouchingNearest(textureCoordinate: import("twgl.js").v3.Vec3): void;
    isTouchingLinear(textureCoordinate: import("twgl.js").v3.Vec3): void;
  }
  ...
  export interface Skin {
    ...
    _rotationCenter: import("twgl.js").v3.Vec3;
    get rotationCenter(): import("twgl.js").v3.Vec3;
     ...
     */
    isTouchingNearest(textureCoordinate: import("twgl.js").v3.Vec3): boolean;

    /**
     * @see {Silhouette.isTouchingLinear}
     */
    isTouchingLinear(textureCoordinate: import("twgl.js").v3.Vec3): boolean;
  ...
  interface BitmapSkin extends Skin {
  ...
  interface SVGSkin extends Skin {
    _renderer: RenderWebGL;
  ...
  interface PenSkin extends Skin {
    _renderer: RenderWebGL;
    ...
    _lineBufferInfo: import("twgl.js").BufferInfo;
    _lineShader: Shader;
  ...
  interface TextBubbleSkin extends Skin {
    _renderer: RenderWebGL;
  ...
  class Drawable {
    ...
    static sampleColor4b(
      coordinate: import("twgl.js").v3.Vec3,
      drawable: Drawable,
    ...
    _uniforms: {
      u_modelMatrix: import("twgl.js").m4.Mat4;
    ...
    _rotationMatrix: import("twgl.js").m4.Mat4;
    _rotationTransformDirty: boolean;

    _rotationAdjusted: import("twgl.js").v3.Vec3;
    _rotationCenterDirty: boolean;

    _skinScale: import("twgl.js").v3.Vec3;
    ...
    _inverseMatrix: import("twgl.js").m4.Mat4;
    ...
    isTouching(textureCoordinate: import("twgl.js").v3.Vec3): boolean;
    _isTouchingNearest(textureCoordinate: import("twgl.js").v3.Vec3): boolean;
    _isTouchingLinear(textureCoordinate: import("twgl.js").v3.Vec3): boolean;
    _isTouchingNever(textureCoordinate: import("twgl.js").v3.Vec3): false;
...
interface RenderWebGL extends EventEmitter<RenderWebGL.ScratchRenderEventMap> {
  ...
  // static sampleColor3b(vector: import("twgl.js").v3.Vec3, drawableIds: number[], destination?: Uint8ClampedArray): Uint8ClampedArray;
  ...
  _drawThese(
    ...
    projection: import("twgl.js").m4.Mat4,
    opts?: {
  ...
  _projection: import("twgl.js").m4.Mat4;
  ...
  _bufferInfo: import("twgl.js").BufferInfo;
